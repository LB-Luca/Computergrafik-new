...
{
  vec4 data0 = in_Vertices[nonuniformEXT(gl_InstanceCustomIndexEXT)].v[5 * index + 0];
  vec4 data1 = in_Vertices[nonuniformEXT(gl_InstanceCustomIndexEXT)].v[5 * index + 1];
  vec4 data2 = in_Vertices[nonuniformEXT(gl_InstanceCustomIndexEXT)].v[5 * index + 2];
  vec4 data3 = in_Vertices[nonuniformEXT(gl_InstanceCustomIndexEXT)].v[5 * index + 3];
